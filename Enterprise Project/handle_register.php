...
if ($conn->connect_error) {
    ...
    if ($checkResult->num_rows > 0) {
        ...
        <script>
            ...
            window.location.href = "registerpage.php"; // Redirect to the register page
        </script>
        <?php
        exit();
    } else {
        ...
        if ($stmt->execute()) {
            ...
            <script>
                ...
                window.location.href = "registerpage.php"; // Redirect to the register page if an error occurs
            </script>
            <?php
            exit();
        }
